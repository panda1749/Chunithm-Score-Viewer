...
f.b=function(){this.Lb=this.cb=null;Qf.a.b.call(this)};var Sf={basic:0,advanced:1,expert:2,expart:2,master:3,worldsend:4},Tf=["basic","advanced","expert","master","worldsend"],Uf=["basic","advanced","expart","master","worldsend"],Vf=[99,0,2,3,6,1,7,8,5],Wf={99:"全ジャンル",0:"POPS \x26 ANIME",2:"niconico",3:"東方Project",6:"VARIETY",1:"GAME",7:"イロドリミドリ",8:"言ノ葉Project",5:"ORIGINAL"};function Xf(){Q.call(this)}w(Xf,Q);Xf.prototype.Va=n;Xf.prototype.V=n;Xf.prototype.import=function(a){console.log(this,a);this.addAll(a)};Xf.prototype.hc=function(){return Oe(this)};function Yf(a,b){return Zf(a,$a(arguments,1))}function $f(a,b,c){var d=3>=arguments.length?a:Zf(a,$a(arguments,2,-1)),e=Ia(arguments);if(t(b)){var g=b(B(d,e));d[e]=g}else d[e]=b}function Zf(a,b){return z(b,function(a,b){return null!=a?a[b]:null},a)};function ag(a){this.I=a||{cookie:""}}var bg=/\s*;\s*/;f=ag.prototype;f.isEnabled=function(){return navigator.cookieEnabled};
...
function ch(a){if(null!=a.Jc)return a.Jc;var b=a.Ad,c=a.ab,d=a.jd,e=B(a.D,"filter"),g=B(e,"nonplay"),h=B(e,"score"),c={id:b,title:c.j("musicNameMap",b),ie:B(a.D,"dif"),Eb:Xg(c,b),lc:[],kc:[],Wd:0,fd:0,vd:0,Md:0,Nc:0,Zc:[],filter:[]},e=c.Eb,m=null!=e?B(e,"scoreMax",0):0,u=101E4===m?!0:!1;c.Md=m;z(d,function(a,c){var d=Xg(c,b),e=null!=d,hb=e?B(d,"scoreMax",0):0,Lh=101E4===hb?!0:!1;c=c.j("userName");var hb=m-hb,ib,Ha=!1;0===hb?(a.fd++,ib="draw"):0<hb?(a.Wd++,ib="win"):(a.vd++,ib="lose");g&&!e?Ha=!0:
1===h&&u?Ha=!0:2<=h&&"win"===ib?Ha=!0:"draw"===ib&&(3===h&&Lh?Ha=!0:4===h&&(Ha=!0));Ha||(a.Nc+=hb);a.Zc.push(ib);a.kc.push(d);a.lc.push(c);a.filter.push(Ha);return a},c);return a.Jc=c};function hh(a,b){I.call(this,a);this.Fc=b}w(hh,I);
...
b=F(["box02","w400","p_10"],b);this.i=F(["w420","box01","text_b"],a,b)};f.h=function(){xh.a.h.call(this)};f.O=function(){return this.Td};f.eb=function(a,b){this.Td=a;null!=b&&(this.Sc=b);yh(this)};function zh(a,b){a.Bc=b;yh(a)}f.complete=function(a){this.eb(this.Bc,a||"Complete!")};function yh(a){a.f();var b=a.Bc,c=a.O(),d=a.Sc,e=a.wd,g=a.Yc,h=a.Qd;dc(a.dd,b-c);Sc(g,"width",""+c/b*100+"%");Sc(e,"left",""+c/b*100+"%");null!=d&&dc(h,d)}f.b=function(){xh.a.b.call(this)};function Ah(a){this.Ya=a.getKey();this.cc=xg.o().get(Bh+this.Ya,{})}var Bh="view_",Ch=Bh+"global";Ah.prototype.get=function(a,b){return B(this.cc,a,b)};Ah.prototype.set=function(a,b){this.cc[a]=b};Ah.prototype.save=function(){xg.o().set(Bh+this.Ya,this.cc)};function Dh(a){S.call(this,+new Date(B(a,"userPlayDate")));this.set(Eh,a)}w(Dh,S);var Eh="playlogdata";Dh.prototype.N=M("GetUserPlaylogDetailApi");Dh.prototype.V=id;Dh.prototype.F=function(){var a=Dh.a.F.call(this),b=this.get(Eh);a.orderId=b.orderId;return a};function Fh(a){a=a.get(Eh);return Sf[a.levelName]};function Gh(){S.call(this)}w(Gh,S);Gh.prototype.N=M("GetUserPlaylogApi");function Hh(a,b){var c=a.j("length");if(b>=c)return null;a=a.j("userPlaylogList",b,"userPlayDate");return+new Date(a)}function Ih(a,b){var c;c=null!=c?c:!0;b=r(b)?b:0;a=a.j("userPlaylogList");a=Oa(a,function(a,e){var g=+new Date(e.userPlayDate),h=Aa(e.musicFileName,e.levelName);!(!0===c&&g>b||!1===c&&g<b)||h in a||(e=new Dh(e),qb(a,h,e));return a},{});return mb(a)};function Jh(){Y.call(this);this.zd=null}w(Jh,Y);f=Jh.prototype;f.N=M("GetWorldsEndMusicApi");f.V=jd;f.F=function(){var a={};a.userId=dg.get("userId",null);return a};f.qc=function(a){var b=this.Db;null==b&&(b=this.j("weMusicList"),this.Db=b=z(b,function(a,b){a[b.musicName]=b.musicId;return a},{}));a=parseInt(B(b,a),10);return Number.isNaN(a)?null:a};f.na=function(a){a=null!=a?a:!0;var b=Jh.a.na.call(this);return a?kb(b,function(a,b){return null!=this.rc(b)},this):b};
f.rc=function(a){var b=this.j("weMusicList"),c=this.zd;null==c&&(c=this.zd=z(b,function(a,b){a[B(b,"musicId")]=B(b,"musicName");return a},{}));return c[a]};function Kh(a){S.call(this,a)}w(Kh,S);Kh.prototype.N=M("GetUserMusicDetailApi");Kh.prototype.V=id;Kh.prototype.F=function(){var a=Kh.a.F.call(this);a.musicId=this.L();return a};function Mh(a){P.call(this,a);this.ba=oe(ke.o());this.B=new Ah(this.ba);var b=new X(a,"ok");this.be=b.L();K(this,b);a=new xh(a);this.Ic=a.L();K(this,a);this.$a=this.Ga=this.yd=this.Jd=null}w(Mh,P);var Nh=/^is|Max$|^score(?=Rank)/;f=Mh.prototype;f.c=function(){this.f();var a=za(1.2,0),a=F(["text_b","mt_5"],"ver."+a),b=F(["box05","w420"],a),b=F(null,b);ad($c(this,this.Ic),b);this.i=b;this.ya(a)};
f.h=function(){Mh.a.h.call(this);var a=new yf;a.send("//chunithm-net.com/GetScriptVersion.php?"+Date.now());J(this).v(a,"success",function(a){a=Of(a.target);a=B(a,"version");if(120>=a){a=U.o();var c=new Gh,d=new Y(null,0),e=new Y(null,1),g=new Y(null,2),h=new Y(null,3),m=new Jh;a.update([c,d,e,g,h,m],this.Zd,this)}else Oh(this,hc(na("新しいバージョンがあります(ver.%s)\n更新されるのを待ってね",za(a/100,0))))});J(this).v(a,"error",function(a){a=a.target;Oh(this,hc(na("バージョンチェックエラー\n(%s)",q(a.pa)?a.pa:String(a.pa))))});J(this).v(this,
"submit",this.ha);ie(this)};function Ph(a,b,c){var d=a.f();b=F(["mt_20"],na("プレイ履歴 : %s件",b));c=F(["mt_20","mb_20"],na("楽曲別レコード : %s件",c));var e=$c(a,a.be);a=a.H();d.append(a,b,c);ad(e,a)}function Oh(a,b){var c=a.f();a=a.H();c.append(a,b)}
f.Zd=function(a){var b=a.target[0],c=a.target[1],d=a.target[2],e=a.target[3],g=a.target[4],h=a.target[5];U.o();a=this.B.get("updateTime")||0;var m=Hh(b,b.j("length")-1),m=a<m,b=Ih(b,a);a=[];m?(m={},sb(m,c.na(),d.na(),e.na(),g.na(),h.na()),Za(a,nb(m))):z(b,function(a,b){var c=b.get(Eh).musicName;b=4===Fh(b)?h.qc(c):e.qc(c);Ta(a,b);return a},a);c=z(b,function(a,b){a.push(b.get(Eh).musicName+"："+Tf[Fh(b)]);return a},[]);d=z(a,function(a,b){b=new Kh(b);a.push(b);return a},[]);Ph(this,b.length,a.length);
this.Jd=c;this.yd=z(d,function(a,b){b=(8E3<=b.L()?h:e).rc(b.L());a.push(b);return a},[]);this.Ga=b;this.$a=d;zh($c(this,this.Ic),this.Ga.length+this.$a.length)};f.ha=function(){console.log("submitHandler");var a=U.o(),b=$c(this,this.Ic),c=[],d=[];Za(d,this.Ga,this.$a);Za(c,this.Jd,this.yd);console.log("読込数","playLog : "+this.Ga.length,"musicDetail : "+this.$a.length);var e=a.update(d);J(this).v(e,"SI",function(){var a=e.S.T();b.eb(a,c[a])});J(this).v(e,"CG",function(){b.complete();this.update()})};
f.update=function(){console.log("update");this.B.set("updateTime",+Date.now());this.B.save();var a=U.o().B;a.save("GetUserMusicDetailApi");a.save("GetUserPlaylogDetailApi");var b=Qh(this.Ga),c=a.get(new lh),a=Rh(a),b={totalNotes:b,playerInfo:c.j(),musicDetail:a},b=JSON.stringify(b),c=document.createElement("form");document.body.appendChild(c);a=document.createElement("input");a.setAttribute("type","hidden");a.setAttribute("name","scoredata");a.setAttribute("value",b);c.appendChild(a);c.setAttribute("action",
"//chunithm-net.com/updatescore");c.setAttribute("method","post");c.setAttribute("target","_blank");c.submit()};function Qh(a){return z(a,function(a,c){var d=Ia(c.j("userPlaylogDetailList"));c=null;var e=B(d,"musicName"),g=Sf[B(d,"levelName")],d=z(["judgeCritical","judgeJustice","judgeAttack","judgeGuilty"],function(a,b){return a+B(this,b)},0,d);null!==a&&e in a?c=B(a,e):(c={},a[e]=c);c[g]=d;return a},{})}
function Rh(a){var b=a.get(new Y(null,2)),c=a.get(new Jh);a=a.get("GetUserMusicDetailApi");var d=z(b.j("userMusicList"),function(a,c){c=B(c,"musicId");var d={music_id:null==c?"":String(c),music_name:b.j("musicNameMap",c),scoreData:{}};a[c]=d;return a},[]),d=z(c.j("weMusicList"),function(a,b){var c=B(b,"musicId");a[c]={music_id:null==c?"":String(c),music_name:B(b,"musicName"),scoreData:{}};return a},d);a.forEach(function(a,b){a=a.j("userMusicList");y(a,function(a){var c=B(a,"level"),e={};jb(a,function(a,
b){var c=b;switch(b){case "level":c="difficulty";break;case "updateDate":case "musicId":break;default:c=b.replace(Nh,"").toLowerCase()}e[c]=a});d[b].scoreData[c]=e})});return d}f.b=function(){Mh.a.b.call(this);this.$a=this.Ga=this.B=null};function Sh(a){P.call(this,a);a=ke.o();null===a.Ac&&(a.Ac=new L("MAIN","MAIN"));new Ah(a.Ac);a=+Date.now();var b=xg.o(),c=b.get(Ch,{});c.scriptExec=a;b.set(Ch,c);this.f();this.ib=new dd(this.f());K(this,this.ib);this.ua=new Qe(this.f());K(this,this.ua)}w(Sh,P);ba(Sh);f=Sh.prototype;
f.c=function(){var a=this.f();a.I.body.removeAttribute("onload");var b=a.l("inner"),c=F(["frame01_inside","w450"]),d=F(["frame01","w460"],c);this.ib.c();a.appendChild(c,this.ib.l());this.ua.c();a.appendChild(c,this.ua.l());Xc(d,0);d.style.display="none";this.i=d;a=cc(b);je(this,a,d)};f.h=function(){Sh.a.h.call(this);var a=Pb(document,"header");J(this).v(a,"click",this.pd,!1,this);this.pd()};
...
f.Hd=function(a){var b=a.target[0];if(b.getKey()!=this.ua.ba.getKey()){a=this.ua;this.ua=b=new ({MENU:Qe,FRIENDVS:kh,PLAYERDATA:nh,TROPHY:wh,CHUNIVIEWER:Mh}[b.getKey()])(this.f());K(this,b);var c=a.l();ad(b,c.parentNode,c);je(this,a.l(),b.l(),null,this)}};f.Id=function(a){var b=ke.o(),c=a.target;pe(b).getKey()!==c[0].getKey()&&c.unshift(pe(b));fd(this.ib,a.target)};f.b=function(){Sh.a.b.call(this);this.ua=this.ib=null};function Th(){T.call(this,Kh,"GetUserMusicDetailApi")}w(Th,T);function Uh(){T.call(this,Dh,"GetUserPlaylogDetailApi")}w(Uh,T);Uh.prototype.nd=function(a,b){console.log(a,b);return new a(B(b,Eh))};var Re=.03;
...
U.o(),b=new lh;a.update(b,function(){var a=zg.o();Ag(a,Th);Ag(a,Uh);console.log(a);a=Sh.o();ad(a,Pb(document,"inner"))})})();