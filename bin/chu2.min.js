...
f.h=function(){Mh.a.h.call(this);var a=new yf;a.send("//chuniviewer.net/GetScriptVersion.php?"+Date.now());J(this).v(a,"success",function(a){a=Of(a.target);a=B(a,"version");if(120>=a){a=U.o();var c=new Gh,d=new Y(null,0),e=new Y(null,1),g=new Y(null,2),h=new Y(null,3),m=new Jh;a.update([c,d,e,g,h,m],this.Zd,this)}else Oh(this,hc(na("新しいバージョンがあります(ver.%s)\n更新されるのを待ってね",za(a/100,0))))});J(this).v(a,"error",function(a){a=a.target;Oh(this,hc(na("バージョンチェックエラー\n(%s)",q(a.pa)?a.pa:String(a.pa))))});J(this).v(this,
...
f.Hd=function(a){var b=a.target[0];if(b.getKey()!=this.ua.ba.getKey()){a=this.ua;this.ua=b=new ({MENU:Qe,FRIENDVS:kh,PLAYERDATA:nh,TROPHY:wh,CHUNIVIEWER:Mh}[b.getKey()])(this.f());K(this,b);var c=a.l();ad(b,c.parentNode,c);je(this,a.l(),b.l(),null,this)}};f.Id=function(a){var b=ke.o(),c=a.target;pe(b).getKey()!==c[0].getKey()&&c.unshift(pe(b));fd(this.ib,a.target)};f.b=function(){Sh.a.b.call(this);this.ua=this.ib=null};function Th(){T.call(this,Kh,"GetUserMusicDetailApi")}w(Th,T);function Uh(){T.call(this,Dh,"GetUserPlaylogDetailApi")}w(Uh,T);Uh.prototype.nd=function(a,b){return new a(B(b,Eh))};var Re=.03;
