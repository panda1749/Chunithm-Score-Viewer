...
f.ha=function(){console.log("submitHandler");var a=U.o(),b=$c(this,this.Ic),c=[],d=[];Za(d,this.Ga,this.$a);Za(c,this.Jd,this.yd);if(0===d.Me)this.update();else{console.log("読込数","playLog : "+this.Ga.length,"musicDetail : "+this.$a.length);var e=a.update(d);J(this).v(e,"SI",function(){var a=e.S.T();b.eb(a,c[a])});J(this).v(e,"CG",function(){b.complete();this.update()})}};
